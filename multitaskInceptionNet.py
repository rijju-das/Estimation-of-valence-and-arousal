...
test_gen = data_generator(test_dir, val_ann_file, test_img, batch_size, input_shape)
...
history = model.fit(train_gen, steps_per_epoch=30, epochs=50,
                    validation_data=val_gen, validation_steps=10, callbacks=callbacks, verbose=1)

# Evaluate on test set
test_loss, test_valence_loss, test_arousal_loss, test_emotion_loss, test_valence_mae, test_arousal_mae, test_emotion_accuracy, test_valence_ccc, test_arousal_ccc = model.evaluate(test_gen, steps=5, verbose=0)
